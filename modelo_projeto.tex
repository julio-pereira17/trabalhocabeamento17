...
\title{Trabalho Projeto de cabeamento estruturado}					% Title of your article goes here
...
%% ====================================
%% ====================================
\initial{E}\textbf{este projeto tem como objetivo oferecer uma infraestrutura com alta tecnologia de transmissão de dados,
disponibilizando a comunicação em um predio comercial de dois andares.}
...
%% ====================================
\section{Introdução}
Explique nesta primeira seção qual seria o perfil do caso. 
Perfil do cliente, quantidade de colaboradores, quantidade de equipamentos de TI atualmente.

O projeto tem como objetivo prover padrão de administração de cabeamento estruturado, (dados e voz). 
Utilizando padrões de identificação de cada elemento da rede para cada andar do prédio, através de cabeamento horizontal ligado ao armário de telecomunicações que se comunicarão por um backbone


Apresente um overview do parque tecnológico do caso.
\subsection{Benefícios}
Com a utilização de normas regulamentadoras e produtos de qualidade, serpa possivel oferencer segurança, confiabilidade, crescimento, facilidade de manutenção e gerenciamento futuro.
