...
%% ====================================
%% ====================================
\initial{E}\textbf{ste projeto fictício tem como objetivo oferecer uma infraestrutura com alta tecnologia de transmissão de dados, disponibilizando a comunicação para a empresa fictícia JRT Treinamentos. Para isso, serão utilizadas normas regulamentadoras e produtos de qualidade afim de oferecer segurança, confiabilidade, crescimento, facilidade de manutenção e gerenciamento futuro.
}
...
A topologia em estrela foi escolhida para ser feita no cabeamento horizontal, pois ela permite que cada equipamento se conecte ao concentrador de forma individual, sendo assim possivel fazer uma manutenção ou reconfiguração sem afetar o funcionamento da rede.

\subsection{Encaminhamento}
O cabeamento foi realizado nos dois pisos, utilizando eletrocalhas, as tomadas de telecomunicações que disponibilizam dados e vos estão a 45cm do chão conforme as normas legais.
