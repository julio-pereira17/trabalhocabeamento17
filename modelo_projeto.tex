...
\lfoot{\footnotesize \texttt{Trabalho Cabeamento Estruturado} \textbullet ~Modelo de projeto}
...
%% ====================================
%% ====================================
\initial{E}\textbf{ste projeto tem como objetivo oferecer uma infraestrutura com alta tecnologia de transmissão de dados, disponibilizando a comunicação em um prédio comercial de dois andares. Para isso, serão utilizadas normas regulamentadoras e produtos de qualidade afim de oferecer segurança, confiabilidade, crescimento, facilidade de manutenção e gerenciamento futuro.
}
...
%% ====================================
\section{Introdução}
O projeto será realizado para uma empresa privada, hoje na empresa existem 15 colaboradores.
Na equipe de TI, terá 2 profissionais.

O projeto tem como objetivo prover padrão de administração de cabeamento estruturado, (dados e voz). Utilizando padrões de identificação de cada elemento da rede para cada andar do prédio, através de cabeamento horizontal ligado ao armário de telecomunicações que se comunicarão por um backbone.

Apresente um overview do parque tecnológico do caso.
\subsection{Benefícios}

Com as utilizações de normas regulamentadoras e produtos de qualidade poderemos entregar um projeto que vide a segurança, confiabilidade, crescimento, facilidade de manutenção e gerenciamento futuro.
